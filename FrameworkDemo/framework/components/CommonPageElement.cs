...
namespace FrameworkDemo.framework.components
{
    class CommonPageElement
    {
        ...
        private static string AttributeErrorMessage = "Invalid attribute: Attribute cannot be null.";
        private static int TimeoutInSeconds = 10;
        private static int PoolingEveryMilliseconds = 500;
        private static IWebDriver WrappedDriver = Browser.GetInstance().WrappedDriver;
